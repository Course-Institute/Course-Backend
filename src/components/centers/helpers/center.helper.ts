import { CreateCenterRequest, UpdateCenterRequest } from "../models/center.model";

// Validation helper functions
const validateCenterData = (data: CreateCenterRequest): void => {
    const { centerDetails, authorizedPersonDetails, infrastructureDetails, bankDetails, declaration } = data;
